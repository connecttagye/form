...
actual fun createFileManager(): FileManager = object : FileManager {
    override suspend fun readText(path: String): String = TODO("Not supported on JS/Web")
    override suspend fun writeText(path: String, content: String) = TODO("Not supported on JS/Web")
